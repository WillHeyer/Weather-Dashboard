$(document).ready(function () {
    ...
    function getWeather(city) {
        ...
        var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q=" + city + "&appid=65738807a1c6c21d0113b05cea3caf6c"
        $.ajax({
            url: queryURL,
            method: "GET"
            ...
            let coordURL = `http://api.openweathermap.org/data/2.5/uvi?lat=${lat}&lon=${lon}&appid=65738807a1c6c21d0113b05cea3caf6c`
            $.ajax({
                url: coordURL,
                method: "GET"
